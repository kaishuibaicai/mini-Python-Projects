...
def cut_image(resource_path, output_file_path, output_record):
    ...
    for file in files:
        ...
        pre_file_name = 'cartoon_characterdetectionai_Origin_Video_20180105_000000' + '%02d' % index + '_00'
        ...
        output_file_name = pre_file_name + '_Preprocessing_20180105_%08d_00.jpg'

        subprocess.call(['ffmpeg', '-i', file_path, '-r', '1', output_file_name])  # 抽帧命令
 
rp = 'C:\\Users\Administrator\Desktop\missions\哆啦A梦Preprocessing\新建文件夹2'
op = 'C:\\Users\Administrator\Desktop\missions\哆啦A梦Preprocessing\新建文件夹2'
rc = 'nameList'
cut_image(rp, op, rc)